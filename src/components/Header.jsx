        ...
        <>
            <div className='flex flex-row  md:px-[200px] md:pt-[120px] md:pb-[50px] px-[20px] py-[20px] justify-between item-center'>
                ...
                <div className='md:hidden'>
                    ...
                    <div id='hamburgerClose' className='hidden bg-white shadow shadow-lg w-[250px] translate-x-[20px] -translate-y-[20px] px-[20px] py-[20px] h-screen'>
                        <div className='w-full flex justify-end'><img src={hamburgerClose} onClick={closeNavBar} alt="" /></div>
